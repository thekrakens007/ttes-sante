...
export class AppSidebarComponent {
  ...
  navItems: NavItem[] = [
    ...
    {
      name: "Stocks & commandes",
      icon: `<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none"
    xmlns="http://www.w3.org/2000/svg">
    <path fill-rule="evenodd" clip-rule="evenodd"
      d="M4 4.75C4 3.7835 4.7835 3 5.75 3H18.25C19.2165 3 20 3.7835 20 4.75V19.25C20 20.2165 19.2165 21 18.25 21H5.75C4.7835 21 4 20.2165 4 19.25V4.75ZM5.5 4.75C5.5 4.33579 5.83579 4 6.25 4H17.75C18.1642 4 18.5 4.33579 18.5 4.75V19.25C18.5 19.6642 18.1642 20 17.75 20H6.25C5.83579 20 5.5 19.6642 5.5 19.25V4.75Z"
      fill="currentColor">
    </path>
  </svg>`,
      subItems: [
        { name: "Commandes", path: "/admin/orders" },
        { name: "Inventaires", path: "/admin/inventories" }
      ]
    },
    {
    ...
    xmlns="http://www.w3.org/2000/svg">
    <path fill-rule="evenodd" clip-rule="evenodd"
      d="M12 2.75C6.89137 2.75 2.75 6.89137 2.75 12C2.75 17.1086 6.89137 21.25 12 21.25C17.1086 21.25 21.25 17.1086 21.25 12C21.25 6.89137 17.1086 2.75 12 2.75ZM12 4.25C16.2802 4.25 19.75 7.71979 19.75 12C19.75 16.2802 16.2802 19.75 12 19.75C7.71979 19.75 4.25 16.2802 4.25 12C4.25 7.71979 7.71979 4.25 12 4.25ZM12 6.5C10.067 6.5 8.5 8.067 8.5 10C8.5 11.933 10.067 13.5 12 13.5C13.933 13.5 15.5 11.933 15.5 10C15.5 8.067 13.933 6.5 12 6.5ZM12 15C9.79086 15 8 16.7909 8 19H16C16 16.7909 14.2091 15 12 15Z"
      fill="currentColor">
    </path>
  </svg>`,
      subItems: [
